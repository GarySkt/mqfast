...
$sel = $con->prepare("SELECT producto,foto,cantidad,precio, clave, direccion, nombre, fecha FROM compras WHERE estado_compra = 'COMPRADO' AND estado_envio = 'ENTREGADO' ORDER BY fecha DESC   ");
$sel->execute();
