...
<div class="container" style="margin-top: 1%;">
    ...
    <div class="card-header">Agregar Imagenes</div>        
        ...
        <?php echo $f['producto']?></h4>
            <form action="ins_imagenes.php" method="post" enctype="multipar/form-data">
    ...
    <div class="row">
        ...
        ?>
        <div class="col-4">
                <h1><?php echo $f_img['ruta']?></h1>
                <div class="card" style="width: 20rem; margin-top: 1%;">

                    <a href="#" onclick="bootbox.confirm('Deseas realizar esta accion?.',function(result){if (result == true){
                        location.href='eliminar_imagen.php?clave_producto=<?php echo $clave?>&clave_img=<?php echo $f_img['clave'
                        ]?>&ruta=<?php echo $f_img['ruta']?>';}})">
                        <img src="<?php echo $f_img['ruta']?>" alt="" class="card-img-top">
                    </a>
